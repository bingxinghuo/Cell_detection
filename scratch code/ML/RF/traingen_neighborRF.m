% load('trainrawdata.mat','trainimgraw','groupimg')
load('traincenternobakdata.mat','trainimg','groupimg')
for n=3:6
    ...
    for s=1:5 % go through all the training images
        ...
        trainensemv=[trainensemv;[reshape(trainensemimg,rows*cols,N^2*4),reshape(groupimg{s},rows*cols,1)]];
    end
