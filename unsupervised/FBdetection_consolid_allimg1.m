...
%     - FBdetection_consolid_v5.m based on consolidating Keerthi &
%       Bingxing's code
...
parfor f=Nrestart:Nfiles
    try
        ...
        elseif exist([maskfile,'.mat'],'file')
            ...
            imgmask=brainmaskfun_16bittif(fileid,['../',upper(brainid),'F-STIF/'],'./'); % generate a mask for the brain region
        end
        % 1.3 detect cells
