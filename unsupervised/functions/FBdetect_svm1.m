...
% h=h2-h1;
 bg=imgaussfilt(single(imgtemp_rgb),sigma(1));
img_nobak=single(imgtemp_rgb)-bg;
...
%% 4. Visualization
h=imoverlay(uint8(imgtemp_rgb),img_edge,'g');
figure, imagesc(h)