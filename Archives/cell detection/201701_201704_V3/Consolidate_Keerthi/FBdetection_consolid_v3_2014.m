...
function centroids1=FBdetection_consolid_v3_2014(fluoroimg)
global bitinfo
%% 0. parameters
bitinfo=12;
...
% bwimg_smooth=imgaussfilt(single(bwimg1),sigma(2)); % smooth
...
idx = find([stats.Area] > clearpar & [stats.Area] < 5000 & [stats.Eccentricity] < eccpar(2));
idx=idx(idx~=1);
L1 = ismember(L, idx);
% L1=cellsize(L);
